...
class DeviceDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create:
          (context) => DeviceDetailViewModel(
            deviceId: deviceId,
            repository: Provider.of<IotRepository>(context, listen: false),
          ),
      child: Consumer<DeviceDetailViewModel>(
            ...
            body: Consumer<DeviceDetailViewModel>(
              builder: (context, viewModel, child) {
                ...
                if (viewModel.device == null) {
                  return const Center(
                    child: Text('Dispositivo no encontrado.'),
                  );
                }
                      ...
                      children: [
                          ...
                          child: ListTile(
                            ...
                            subtitle: Text(
                              isConnected
                                  ? 'Conectado'
                                  : (lastSeen != null
                                      ? 'Última vez online: ${lastSeen.toLocal()}'
                                      : 'Desconocido'),
                            ),
                          ),
                        ),
                        ...
                        Card(
                          child: SwitchListTile.adaptive(
                            ...
                            subtitle: const Text(
                              'Encendido por movimiento y poca luz',
                            ),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Nivel de Iluminación: ${device.lightLevel} lux',
                                ),
                              ],
                            ),
                          ),
                          ...
                          onPressed: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder:
                                    (context) =>
                                        HistoryScreen(deviceId: device.id),
                              ),
                            );
                          },
                        ),
                            ...
                            showDialog(
                              ...
                              builder: (BuildContext dialogContext) {
                                return AlertDialog(
                                  ...
                                  content: const Text(
                                    'Esta acción es permanente y eliminará el dispositivo de tu cuenta.',
                                  ),
                                  actions: <Widget>[
                                    TextButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (success) {
                                          ...
                                          ScaffoldMessenger.of(
                                            ...
                                            const SnackBar(
                                              content: Text(
                                                'Error al desvincular el dispositivo.',
                                              ),
                                            ),
                                          );
                                        }
